...
<template>
    <th
        ...
        <div
            ...
            class="py-1 mb-1 px-3 lg:mb-1.5 cursor-pointer select-none inline-flex items-center border border-transparent text-sm text-gray-500 rounded-md hover:border-gray-200">
            {{ tableHeader.title }}
