...
function getPhotos() {
    axios.get('/admin/lot/create/tmp-restore')
        .then(response => {
...
function reorderFiles(files, origin, target) {
    ...
    axios.post('/admin/lot/create/tmp-reorder', photoPosition)
        .catch((error) => {
            console.log(error);
        });
}
...
<template>
    ...
    <MainLayout>
        ...
        <div class="p-2 lg:p-4 max-w-2xl mx-auto shadow sm:rounded-2xl bg-white">
            ...
            <form :disabled="form.processing" @submit.prevent="form.post(route('admin-lot.store'),{
                    ...
                    <div class="h-full text-gray-900">
                        ...
                        <file-pond
                            ...
                            :server="{
                                ...
                                timeout: 120000,
                                process:{
                                    url: '/admin/lot/create/tmp-upload',
                                    method: 'POST',
                                ...
                                revert:{
                                    url: '/admin/lot/create/tmp-revert',
                                    method: 'DELETE',
